const myApp = angular
    ...
    .controller("loginController", ["$scope", "$location", "Auth", "$http", "UserProfile", function($scope, $location, Auth, $http, UserProfile) {
...
myApp.service("Auth", [
    ...
    function($http) {
        ...
        this.getProfile = function() {
            return $http.get("/db/token?token=" + window.localStorage.getItem('token'));
        };
    },
]);
